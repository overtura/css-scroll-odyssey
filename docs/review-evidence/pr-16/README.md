...
- 변경 후(현재 PR head): `c7b558abede4f51a962f6d04122e7e04ffa99c26`
- 대상 요소: `#signal .chapter-copy`
- 검증 브라우저: Playwright Chromium

현재 PR head에는 별도의 보정 커밋이 없습니다. 이번 대응은 기존 CSS를 수정하지 않고 누락된 시각 검증 증거를 추가한 것입니다. 따라서 이전 처리 기록의 “보정 커밋을 추가했다”는 설명은 “보정 커밋 없이 검증 증거를 추가했다”로 정정해야 합니다.
