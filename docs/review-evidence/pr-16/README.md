...
- 변경 후(현재 PR head): `e774c9252b7ca3d1668c39d946aeb29cdc0322a0`
- 대상 요소: `#signal .chapter-copy`
- 검증 브라우저: Playwright Chromium (1440 × 1000, 560 × 1000)

현재 PR head는 두 번째 커밋입니다. 첫 번째 커밋 `c7b558a`의 CSS 13줄 변경에 두 번째 커밋 `e774c92`의 README 39줄과 PNG 4개가 추가되어, 전체 diff는 6개 파일, `+52/-0`입니다.
